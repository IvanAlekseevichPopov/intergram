...
app.post('/:projectId/hook', function (req, res) {
    ...
    try {
        ...
        // io.to(chatId).emit(projectId + "-" + chatId, msg);
        io.to(chatId).emit(req.params.projectId + "-" + chatId, {name, text, from: 'admin'});
        // } else if (text){
...
io.on('connection', function (socket) {
    ...
    socket.on('register', function (registerMsg) {
        ...
        let projectId = registerMsg.projectId;
        ...
        socket.on('message', function (msg) {
            ...
            sendMessage(projectId, chatId, msg.text);
        });

        socket.on('disconnect', function () {
            if (messageReceived) {
                sendMessage(projectId, chatId, "user has left");
            }
        });
    });
});

function sendMessage(projectId, chatId, text) {
